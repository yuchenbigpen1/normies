...
/**
 * Non-directional sidebar layout icon with rounded design.
 * Shows a vertical divider with horizontal lines in the left panel,
 * indicating a sidebar without implying collapse/expand direction.
 */
