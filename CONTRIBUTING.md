# Contributing to Normies

Thank you for your interest in contributing to Normies! This document provides guidelines and instructions for contributing.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/yuchenzhang/normies.git
   cd normies
   ```
