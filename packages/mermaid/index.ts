/**
 * Generates index.html showcasing all @normies/mermaid rendering capabilities.
 *
...
<body>
    ...
    <div class="brand-badge-wrapper">
      ...
      <div class="brand-dropdown shadow-modal-small" id="brand-dropdown">
        <a href="https://agents.craft.do" class="brand-dropdown-item" target="_blank" rel="noopener">
          ...
          <span style="margin-left: -2px;">Normies<span class="tagline">Simply mind-blowing</span></span>
        </a>
  ...
  <header class="hero-header">
    ...
    <div class="hero-buttons">
      ...
      <a href="https://github.com/yuchenzhang/normies/tree/main/packages/mermaid" target="_blank" rel="noopener" class="hero-btn hero-btn-secondary">
...
${bundleJs}
  ...
  <footer class="site-footer">
    ...
    <div class="footer-links">
      ...
      <a href="https://github.com/yuchenzhang/normies/tree/main/packages/mermaid" target="_blank" rel="noopener noreferrer">
