...
function getElectronEnv(): Record<string, string> {
  ...
  return {
    ...
    NORMIES_CONFIG_DIR: process.env.NORMIES_CONFIG_DIR || "",
    CRAFT_APP_NAME: process.env.CRAFT_APP_NAME || "Normies",
    CRAFT_DEEPLINK_SCHEME: process.env.CRAFT_DEEPLINK_SCHEME || "normies",
